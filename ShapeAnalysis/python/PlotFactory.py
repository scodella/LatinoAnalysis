          ...
          for variableName, variable in self._variables.iteritems():
            ...
            for sampleName, plotdef in plot.iteritems():
              ...
              if self._mergeBins and 'CR' in cutName:
                  ...
                  errorYield = ROOT.double() #ctypes.c_double()
                  ...
                  if cutName not in mergeCRs:
                      ...
                      errorYieldM = ROOT.double() #ctypes.c_double()
                      histoYieldM = histoM.IntegralAndError(-1,-1,errorYieldM)
                      histoB.SetBinContent(1, histoYield+histoYieldM)
                      histoB.SetBinError(1, math.sqrt(errorYield*errorYield+errorYieldM*errorYieldM))
                  histo = histoB
                      ...
                      if histoVar != None :
                        if self._mergeBins and 'CR' in cutName:
                          ...
                          if cutName not in mergeCRs:
                            ...
                            histoVarB.SetBinError(1, errorYield)
                          else:
                            ...
                            histoVarB.SetBinError(1, math.sqrt(errorYield*errorYield+errorYieldM*errorYieldM))
                          histoVar = histoVarB
                        nuisanceHistos[ivar][nuisanceName] = histoVar
            ...
            if self._postFit == 'p':
                ...
                if self._mergeBins and 'CR' in cutName:
                    ...
                    if cutName not in mergeCRs:
                        ...
                        errorYieldPFM = ROOT.double() #ctypes.c_double()
                        histoYieldPFM = histoPFM.IntegralAndError(-1,-1,errorYieldPFM)
                        histoPFB.SetBinContent(1, histoYieldPF+histoYieldPFM)
                        histoPFB.SetBinError(1, math.sqrt(errorYieldPF*errorYieldPF+errorYieldPFM*errorYieldPFM))
                    histoPF = histoPFB
