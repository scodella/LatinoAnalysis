        ...
        'TightObjWP' : {
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(0.887 + 0.088*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(0.112 + 0.099*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(-0.017 + 0.137*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(0.887)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(0.112)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(-0.017)' ] ,
                    } ,
                'tkSF':  { 
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/EGM2D_BtoH_combineLowEt_RecoSF_Legacy2016.root' ,
                    } ,
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<40.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(3.447 + 0.063*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<40.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(2.522 + 0.058*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<40.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(1.555 + 0.075*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=40. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(4.392)' ] ,
                    'electron_col[LF_idx]["pt"]>=40. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(3.392)' ] ,
                    'electron_col[LF_idx]["pt"]>=40. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(2.680)' ] ,
                    } ,
                'tkSF':  { 
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/EGM2D_BtoH_combineLowEt_RecoSF_Legacy2016.root' ,
                    } ,
        ...
        'TightObjWP' : {
            ...
            'SusyMVAVLoose' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(1.204 + 0.066*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(0.084 + 0.033*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(-0.123 + 0.053*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(1.204)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(0.084)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(-0.123)' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/egammaEffi.txt_EGM2D_updatedAll.root',
                    } ,
            ...
            'SusyMVATight' : {
                'cuts' : { 
                    ...
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] >  math.tanh(4.277 + 0.112*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(3.152 + 0.060*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]<25.  and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(2.359 + 0.087*(electron_col[LF_idx]["pt"] - 25))' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])<0.8' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(4.277)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=0.8   and abs(electron_col[LF_idx]["eta"])<1.479' : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(3.152)' ] ,
                    'electron_col[LF_idx]["pt"]>=25. and abs(electron_col[LF_idx]["eta"])>=1.479 and abs(electron_col[LF_idx]["eta"])<2.5'   : [ 'electron_col[LF_idx]["mvaFall17V2noIso"] > math.tanh(2.359)' ] ,
                    } ,
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/egammaEffi.txt_EGM2D_updatedAll.root',
                    } ,
    ...
    'Full2016v8HIPM': {
        ...
        'TightObjWP' : {
            ...
            'cutBasedMediumPOG' : {
                ...
                'tkSF':  { 
                    '1-3' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v8/egammaEffi_ptAbove20.txt_EGM2D_UL2016preVFP.root' ,
                    '4-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v8/egammaEffi_ptAbove20.txt_EGM2D_UL2016postVFP.root' ,
                    } ,
                'susySF':  {
                ...
                'extraSF':  {
                    '1-3' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v8/AdditionalSF_2016HIPMEle#hSFDataMC_central' ,  
                    '4-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v8/AdditionalSF_2016noHIPMEle#hSFDataMC_central' ,  
                    } ,
                'fsSF': {
                    '1-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v2/detailed_ele_full_fast_sf_17.root#CutBasedMediumNoIso94XV2_sf#MVAVLooseTightIP2DMini_sf' , 
                    },
    ...
    'Full2017v8': {
        ...
        'TightObjWP' : {
            ...
            'cutBasedMediumPOG' : {
                ...
                'tkSF':  { 
                    '1-5' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017v8/egammaEffi_ptAbove20.txt_EGM2D_UL2017.root',
                  } ,
                'susySF':  {
                    '1-5' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017v8/egammaEffi.txt_EGM2D_Medium_UL17.root#EGamma_SF2D' , 
                    } ,
                'extraSF':  {
                    '1-5' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017v8/AdditionalSF_2017Ele#hSFDataMC_central' ,   
                    } ,
                'fsSF': {
                    '1-5' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017/detailed_ele_full_fast_sf_17.root#CutBasedMediumNoIso94XV2_sf#MVAVLooseTightIP2DMini_sf' , 
                    },
    ...
    'Full2018v8': {
        ...
        'TightObjWP' : {
            ...
            'cutBasedMediumPOG' : {
                ...
                'tkSF':  { 
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018v8/egammaEffi_ptAbove20.txt_EGM2D_UL2018.root',
                    } ,
                'susySF':  {
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018v8/egammaEffi.txt_Ele_Medium_EGM2D.root#EGamma_SF2D' ,  
                    } ,
                'extraSF':  {
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018v8/AdditionalSF_2018Ele#hSFDataMC_central' ,   
                    } ,
                'fsSF': {
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/detailed_ele_full_fast_sf_18.root#CutBasedMediumNoIso94XV2_sf#MVAVLooseTightIP2DMini_sf' , 
                    },
...
ElectronWP['Full2016v6']['FakeObjWP']['cutBasedVeto'] = ElectronWP['Full2016v6']['VetoObjWP']['cutBasedVeto']
ElectronWP['Full2017v6']['FakeObjWP']['cutBasedVeto'] = ElectronWP['Full2017v6']['VetoObjWP']['cutBasedVeto']
ElectronWP['Full2018v6']['FakeObjWP']['cutBasedVeto'] = ElectronWP['Full2018v6']['VetoObjWP']['cutBasedVeto']
            ...
            'looseRelIsoLoose' : {
                'cuts' : { 
                    'True' :
                        ...
                        'muon_col[LF_idx]["pfRelIso04_all"] < 0.40' , #0.25' , 
                        ]
                    } ,
                }
            } ,
    ...
    'Full2018v7': {
        ...
        'TightObjWP' :  {
            ...
            'looseIsoVeryLoose' : {
                ...
                'susySF':  {
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/RunABCD_SF_ID.root#NUM_LooseID_DEN_TrackerMuons_pt_abseta&LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/RunABCD_SF_ISO.root#NUM_LooseRelIso_DEN_LooseID_pt_abseta' ,
                     } ,
                'fsSF': {
    ...
    'Full2016v8HIPM': {
        ...
        'TightObjWP' :  {
            ...
            'mediumRelIsoTight' : {
                ...
                'extraSF':  {
                    '1-3' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v8/AdditionalSF_2016HIPMMuon#hSFDataMC_central' ,  
                    '4-7' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2016v8/AdditionalSF_2016noHIPMMuon#hSFDataMC_central' ,  
                    } ,
    ...
    'Full2017v8': {
        ...
        'TightObjWP' :  {
            ...
            'mediumRelIsoTight' : {
                ...
                'extraSF':  {
                    '1-5' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017v8/AdditionalSF_2017Muon#hSFDataMC_central' ,   
                    } ,
                'fsSF': {
                    '1-5' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2017/detailed_mu_full_fast_sf_17.root#miniIso01_MediumId_sf' , 
                    },
    ...
    'Full2018v8': {
        ...
        'TightObjWP' :  {
            ...
            'mediumRelIsoTight' : {
                ...
                'extraSF':  {
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018v8/AdditionalSF_2018Muon#hSFDataMC_central' ,   
                    } ,
                'fsSF': {
                    '1-1' : 'LatinoAnalysis/NanoGardener/python/data/scale_factor/Full2018/detailed_mu_full_fast_sf_18.root#miniIso01_MediumId_sf' , 
                    },
...
MuonWP['Full2016v4']['FakeObjWP']['looseRelIsoLoose'] = MuonWP['Full2016v4']['VetoObjWP']['looseRelIsoLoose']
