...
class Mucca2HDMFullVarFiller(TreeCloner):

    def __init__(self):
        pass


    def createMucca2HDMFull(self):
        self.getMucca2HDMFull = ROOT.TMVA.Reader();
        
        # the order is important for TMVA!
        self.getMucca2HDMFull.AddVariable( "mth",                     (self.var1))
        self.getMucca2HDMFull.AddVariable( "mpmet",                   (self.var2))
        self.getMucca2HDMFull.AddVariable( "mtw2",                    (self.var3))
        self.getMucca2HDMFull.AddVariable( "metTtrk",                 (self.var4))
        self.getMucca2HDMFull.AddVariable( "drll",                    (self.var5))
        self.getMucca2HDMFull.AddVariable( "mtw1",                    (self.var6))
        self.getMucca2HDMFull.AddVariable( "mll",                     (self.var7))
        self.getMucca2HDMFull.AddVariable( "ptll",                    (self.var8)) 
        self.getMucca2HDMFull.AddVariable( "dphilmet",                (self.var9))
        self.getMucca2HDMFull.AddVariable( "dphilmet1",               (self.var10))
        self.getMucca2HDMFull.AddVariable( "dphilmet2",               (self.var11))
        self.getMucca2HDMFull.AddVariable( "std_vector_lepton_pt[0]", (self.var12))
        self.getMucca2HDMFull.AddVariable( "metPfType1",              (self.var13))
        self.getMucca2HDMFull.AddVariable( "dphill",                  (self.var14))
        self.getMucca2HDMFull.AddVariable( "std_vector_lepton_pt[1]", (self.var15))
        ...
        self.getMucca2HDMFull.BookMVA("BDT","/afs/cern.ch/user/n/ntrevisa/work/CMSSW_8_0_5/src/MUCCA/Optimization/Weights-2HDM_WW/TMVAClassification_BDT4.weights.xml")
    ...
    def addOptions(self,parser):
        ...
        group.add_option('-s', '--signal', dest='signal', help='Signal model', default='2HDMFull')
    ...
    def process(self,**kwargs):
        ...
        for i in range(nentries):
            ...
            if pt1>0 and pt2>0 : 
              ...
              self.var2[0]  = itree.mpmet
              self.var3[0]  = itree.mtw2
              self.var4[0]  = itree.metTtrk
              ...
              muccamva[0] = self.getMucca2HDMFull.EvaluateMVA("BDT")
