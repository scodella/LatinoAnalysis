...
class Mucca2HDMVarFiller(TreeCloner):

    def __init__(self):
        pass


    def createMucca2HDM(self):
        self.getMucca2HDM = ROOT.TMVA.Reader();
        
        # the order is important for TMVA!
        self.getMucca2HDM.AddVariable("mth",      (self.var1))
        self.getMucca2HDM.AddVariable("mtw2",     (self.var2))
        self.getMucca2HDM.AddVariable("metTtrk",  (self.var3))
        self.getMucca2HDM.AddVariable("drll",     (self.var4))
        self.getMucca2HDM.AddVariable("mll",      (self.var5))
        ...
        self.getMucca2HDM.BookMVA("BDT","/afs/cern.ch/user/n/ntrevisa/work/CMSSW_8_0_5/src/MUCCA/Optimization/Weights-2HDM_TTbar_5var/TMVAClassification_BDT4.weights.xml")
    ...
    def addOptions(self,parser):
        ...
        group.add_option('-s', '--signal', dest='signal', help='Signal model', default='2HDM')
    ...
    def process(self,**kwargs):
        ...
        for i in range(nentries):
            ...
            if pt1>0 and pt2>0 : 
              ...
              muccamva[0] = self.getMucca2HDM.EvaluateMVA("BDT")
